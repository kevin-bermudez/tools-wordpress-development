...
class KdWalkerComment extends Walker{
/**
		...
		<div id="comment-<?php comment_ID(); ?>" class="comment">
			<div class="d-flex">
				<div class="comment-img">
					<?php echo get_avatar( $comment, isset($args['avatar_size']) ? $args['avatar_size'] : 60 ); ?>
				</div>
				<div>
				<h5>
					<a href="<?php echo $comment->comment_author_url ?>" target="_blank">
